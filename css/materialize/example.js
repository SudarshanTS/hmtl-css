...
function checkingField() {
  ...
  setTimeout(function () {document.getElementById('dateField').style.display='none'}, 2000);
  setTimeout(function () {document.getElementById('descriptionField').style.display='none'}, 2000); 
  setTimeout(function () {document.getElementById('statusField').style.display='none'}, 2000);
  setTimeout(function () {document.getElementById('amountField').style.display='none'}, 2000);
 }
